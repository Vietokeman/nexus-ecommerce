...
export class AdminApiAuthApiClient {
  ...
  constructor(
    ...
    @Optional() @Inject(ADMIN_API_BASE_URL) baseUrl?: string
  ) {
    this.http = http;
...
export class AdminApiPostApiClient {
  ...
  updatePost(
    id?: string | undefined,
    body?: CreateUpdatePostRequest | undefined
  ): Observable<void> {
    let url_ = this.baseUrl + '/api/admin/post?';
  ...
  ): Observable<PostInListDtoPagedResult> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<PostInListDtoPagedResult>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetPostsPaging(
    response: HttpResponseBase
  ): Observable<PostInListDtoPagedResult> {
    const status = response.status;
    const responseBlob =
  ...
  protected processGetSeriesBelong(
    response: HttpResponseBase
  ): Observable<SeriesInListDto[]> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
  ...
  returnBack(
    id: string,
    body?: ReturnBackRequest | undefined
  ): Observable<void> {
  ...
  protected processGetActivityLogs(
    response: HttpResponseBase
  ): Observable<PostActivityLogDto[]> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
...
export class AdminApiPostCategoryApiClient {
   ...
   */
  createPostCategory(
    body?: CreateUpdatePostCategoryRequest | undefined
  ): Observable<void> {
  ...
  protected processCreatePostCategory(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  protected processUpdatePostCategory(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  protected processDeletePostCategory(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  protected processGetPostCategories(
    response: HttpResponseBase
  ): Observable<PostCategoryDto[]> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<PostCategoryDto>;
        })
      );
  }

  protected processGetPostCategoryById(
    response: HttpResponseBase
  ): Observable<PostCategoryDto> {
    const status = response.status;
    const responseBlob =
  ...
  getPostCategoriesPaging(
    ...
    pageIndex?: number | undefined,
    pageSize?: number | undefined
  ): Observable<PostCategoryDtoPagedResult> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<PostCategoryDtoPagedResult>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetPostCategoriesPaging(
    response: HttpResponseBase
  ): Observable<PostCategoryDtoPagedResult> {
    const status = response.status;
    const responseBlob =
...
export class AdminApiRoleApiClient {
  ...
  updateRole(
    id: string,
    body?: CreateUpdateRoleRequest | undefined
  ): Observable<void> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<RoleDtoPagedResult>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetRolesAllPaging(
    response: HttpResponseBase
  ): Observable<RoleDtoPagedResult> {
    const status = response.status;
    const responseBlob =
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<PermissionDto>;
        })
      );
  }

  protected processGetAllRolePermissions(
    response: HttpResponseBase
  ...
  protected processSavePermission(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
...
export class AdminApiRoyaltyApiClient {
  ...
  getTransactionHistory(
    ...
    pageIndex?: number | undefined,
    pageSize?: number | undefined
  ): Observable<TransactionDtoPagedResult> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<TransactionDtoPagedResult>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetTransactionHistory(
    response: HttpResponseBase
  ): Observable<TransactionDtoPagedResult> {
    const status = response.status;
    const responseBlob =
  ...
  protected processGetRoyaltyReportByUser(
    response: HttpResponseBase
  ): Observable<RoyaltyReportByUserDto[]> {
    const status = response.status;
    const responseBlob =
  ...
  getRoyaltyReportByMonth(
    ...
    toMonth?: number | undefined,
    toYear?: number | undefined
  ): Observable<RoyaltyReportByMonthDto[]> {
  ...
  protected processGetRoyaltyReportByMonth(
    response: HttpResponseBase
  ): Observable<RoyaltyReportByMonthDto[]> {
    const status = response.status;
    const responseBlob =
...
export class AdminApiSeriesApiClient {
  ...
  updateSeries(
    id?: string | undefined,
    body?: CreateUpdateSeriesRequest | undefined
  ): Observable<void> {
    let url_ = this.baseUrl + '/api/admin/series?';
    if (id === null) throw new Error("The parameter 'id' cannot be null.");
    else if (id !== undefined)
  ...
  protected processDeletePostSeries(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  protected processGetPostsInSeries(
    response: HttpResponseBase
  ): Observable<PostInListDto[]> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
  ...
  protected processGetSeriesById(
    response: HttpResponseBase
  ): Observable<SeriesDto> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
  ...
  getSeriesPaging(
    ...
    pageIndex?: number | undefined,
    pageSize?: number | undefined
  ): Observable<SeriesInListDtoPagedResult> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<SeriesInListDtoPagedResult>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetSeriesPaging(
    response: HttpResponseBase
  ): Observable<SeriesInListDtoPagedResult> {
    const status = response.status;
    const responseBlob =
...
export class AdminApiUserApiClient {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<UserDtoPagedResult>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetAllUsersPaging(
    response: HttpResponseBase
  ): Observable<UserDtoPagedResult> {
    const status = response.status;
    const responseBlob =
   ...
   */
  changeMyPassWord(
    body?: ChangeMyPasswordRequest | undefined
  ): Observable<void> {
  ...
  protected processChangeMyPassWord(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  setPassword(
    id: string,
    body?: SetPasswordRequest | undefined
  ): Observable<void> {
  ...
  protected processAssignRolesToUser(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
...
export class CreateUpdatePostCategoryRequest
  implements ICreateUpdatePostCategoryRequest
{
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.dateModified = _data['dateModified']
        ? new Date(_data['dateModified'].toString())
        : <any>undefined;
      this.seoDescription = _data['seoDescription'];
      this.sortOrder = _data['sortOrder'];
    }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.paidDate = _data['paidDate']
        ? new Date(_data['paidDate'].toString())
        : <any>undefined;
      this.categoryId = _data['categoryId'];
      this.content = _data['content'];
...
export class UserDto implements IUserDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.dob = _data['dob']
        ...
        : <any>undefined;
      this.avatar = _data['avatar'];
      this.vipStartDate = _data['vipStartDate']
        ? new Date(_data['vipStartDate'].toString())
        : <any>undefined;
      this.vipExpireDate = _data['vipExpireDate']
        ? new Date(_data['vipExpireDate'].toString())
        : <any>undefined;
      this.lastLoginDate = _data['lastLoginDate']
        ? new Date(_data['lastLoginDate'].toString())
        : <any>undefined;
  ...
  toJSON(data?: any) {
    ...
    data['dob'] = this.dob ? this.dob.toISOString() : <any>undefined;
    data['avatar'] = this.avatar;
    data['vipStartDate'] = this.vipStartDate
      ? this.vipStartDate.toISOString()
      : <any>undefined;
    data['vipExpireDate'] = this.vipExpireDate
      ? this.vipExpireDate.toISOString()
      : <any>undefined;
