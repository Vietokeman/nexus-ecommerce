...
```
Server=localhost;Port=5433;Database=ProductDb;User Id=admin;Password=0977452762Viet;
```

### Connection String mẫu (URI):
```
postgresql://admin:0977452762Viet@localhost:5433/ProductDb
```
